...
- **Clique Management**: A _clique_ is a group of features associated to the same landmark. We jointly estimate their persistence using a Bayesian survival model. Clique assignment is an approach to _anchoring_ in the computer vision world.
